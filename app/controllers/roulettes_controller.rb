class RoulettesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @roulette.save
        format.html { redirect_to @roulette, notice: 'La Imagen del Carrusel ha sido subida satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @roulette.update(roulette_params)
        format.html { redirect_to @roulette, notice: 'La Imagen del Carrusel ha sido actualizada satisfactoriamente.' }
  ...
  def destroy
    @roulette.destroy
    respond_to do |format|
      format.html { redirect_to roulettes_url, notice: 'La Imagen del Carrusel ha sido eliminada satisfactoriamente.' }
  ...
  private
    ...
    def roulette_params
      params.require(:roulette).permit(:user_id, :titulo_carrusel, :subtitulo_carrusel, :cuerpo_carrusel, :imagen_carrusel,
        :nombre_carrusel)
    end
end
