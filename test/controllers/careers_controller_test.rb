...
class CareersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post careers_url, params: { career: { descripcion_carrera: @career.descripcion_carrera } }
    end
  ...
  test "should update career" do
    patch career_url(@career), params: { career: { descripcion_carrera: @career.descripcion_carrera } }
