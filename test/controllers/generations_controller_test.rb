...
class GenerationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create generation" do
    assert_difference('Generation.count') do
      post generations_url, params: { generation: { career_id: @generation.career_id, descripcion_generacion: @generation.descripcion_generacion } }
    end
  ...
  test "should update generation" do
    patch generation_url(@generation), params: { generation: { career_id: @generation.career_id, descripcion_generacion: @generation.descripcion_generacion } }
