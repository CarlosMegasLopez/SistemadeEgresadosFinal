...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { descripcion_logro: @achievement.descripcion_logro, imagen_logro: @achievement.imagen_logro, titulo_logro: @achievement.titulo_logro, user_id: @achievement.user_id } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { descripcion_logro: @achievement.descripcion_logro, imagen_logro: @achievement.imagen_logro, titulo_logro: @achievement.titulo_logro, user_id: @achievement.user_id } }
